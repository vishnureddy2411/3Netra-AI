...
export default function GateStep3({ onAnswer, onBack }: Props) {
  ...
  return (
    <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-5 w-full max-w-sm">
      ...
      <p className="text-xs text-[#484f58] mb-4">
        Skip if you want agents to research and suggest the best
        projects for your role and purpose
      </p>
      ...
      <textarea
        ...
        placeholder="Describe your project idea... (or skip and we will suggest)"
        rows={3}
        autoFocus
